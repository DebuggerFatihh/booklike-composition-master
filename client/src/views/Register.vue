...
//burada id olmali mi sence  id: null, gibi
  username: null,
  fullname: null,
  password: null
});
//https://localhost:7255/api/User/user?username=adem&password=e2a88b610d7a4eefcd6ba4498c8131ed91afd918


const onSave = () => {
  const password = CryptoJS.HmacSHA1(userData.value.password, store.getters._saltKey).toString();
  appAxios.post("/User", { ...userData.value, password }).then(() => {
